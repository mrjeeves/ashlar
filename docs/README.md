...
| [`writing-ashlar.md`](writing-ashlar.md) | The traps that catch agents who guess instead of reading the reference in `AGENTS.md`. |
...
vision: it is the contract the tests encode. The agent-read gate protocol and its run results live in
