...
part page {
  ...
  view = () => el("div", { class: "stage" }, [
    ...
    el("div", { class: "card" }, [
      ...
      el("h1", {}, ["enclave"]),
      el("p", { class: "lede" }, ["Everyone running this program is on one mesh, and nobody else can see it. The grid below is the roster — live, server-rendered, no client code."]),
      el("h2", {}, ["Who is here"]),
      el(mesh.grid, {}),
