...
//
// `watches Entry` / `updates Entry` make the foreign store REACTIVE (§9.3):
...
foreign record: (who: text, note: text, amount: number) -> bool updates Entry
foreign recent: () -> [Entry] watches Entry
foreign total: () -> number watches Entry
